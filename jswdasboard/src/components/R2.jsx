    ...
    <div className="flex flex-col justify-center border border-black/40 p-1 rounded-md text-xs bg-[whitesmoke] shadow-md">
      <div className="flex justify-between px-1 border-b pb-2 items-center border-black/40 pt-1 italic pr-2">
        ...
        <p className="font-semibold">
          {roundOff(calculateTime("f_R1R2TravelTimeDelay"))}
        </p>
      </div>
      <div className="flex justify-between px-1 border-b pb-2 items-center border-black/40 pt-1 italic pr-2">
        ...
        <p>-</p>
        <p className="font-semibold">
          {roundOff(calculateTime("f_R2GapTimeAct", "average"))}
        </p>
      </div>
      {period !== "Last Coil" && (
        <>
          <div className="flex justify-between px-1 border-b pb-2 items-center border-black/40 pt-1 italic pr-2">
            ...
            <p>-</p>
            <p className="font-semibold">
              {roundOff(getMinMax("f_R2GapTimeAct", "min"))}
            </p>
          </div>
          <div className="flex justify-between px-1 border-b pb-2 items-center border-black/40 pt-1 italic pr-2">
            ...
            <p>-</p>
            <p className="font-semibold">
              {roundOff(getMinMax("f_R2GapTimeAct", "max"))}
            </p>
          </div>
        </>
      )}
      <div className="flex justify-between px-1 border-b pb-2 items-center pt-1 italic pr-2 border-black/40">
        ...
        <p>-</p>
        <p className="font-semibold">
          {roundOff(calculateTime("f_R2ProcessTimeAct", "average"))}
        </p>
      </div>
      <div className="flex justify-between px-1 border-b pb-2 items-center pt-1 italic pr-2 border-black/40">
      ...
      <div className="flex justify-between px-1 pb-1 items-center pt-1 italic pr-2">
        ...
        <p>-</p>
        <p className="font-semibold">
          {roundOff(calculateTime("f_R2ProcessTimeDelay"))}
        </p>
      </div>
    </div>
  );
