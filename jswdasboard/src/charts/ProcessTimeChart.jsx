    ...
    if (period == "Last Coil" || period.customp) {
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        if (
          ...
          if (EP?.pacing?.f_SSPProcessTimeAct?.toFixed(1) <= 1) {
            arr1.push(1);
          } else {
            arr1.push(0);
          }
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        let one = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (currentValue.f_SSPProcessTimeAct <= 1) {
        ...
        let five = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_SSPProcessTimeAct > 1 &&
              currentValue.f_SSPProcessTimeAct <= 5
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let ten = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_SSPProcessTimeAct >= 5 &&
              currentValue.f_SSPProcessTimeAct <= 10
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let nine = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_SSPProcessTimeAct >= 10 &&
              currentValue.f_SSPProcessTimeAct <= 999
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
    ...
    if (period == "Last Coil" || period.customp) {
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        if (
          ...
          if (EP?.pacing?.f_FMProcessTimeAct?.toFixed(1) <= 1) {
            arr1.push(1);
          } else {
            arr1.push(0);
          }
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        let one = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (currentValue.f_FMProcessTimeAct <= 1) {
              accumulator = accumulator + 1;
            }
          } else if (
            currentValue.f_F1GapTimeAct?.toFixed(2) >= index &&
        ...
        let five = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_FMProcessTimeAct >= 1 &&
            ...
            if (
              currentValue.f_FMProcessTimeAct >= 1 &&
              currentValue.f_FMProcessTimeAct <= 5
            ) {
              accumulator = accumulator + 1;
            }
          }
        ...
        let ten = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_FMProcessTimeAct >= 5 &&
              currentValue.f_FMProcessTimeAct <= 10
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let nine = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_FMProcessTimeAct >= 10 &&
              currentValue.f_FMProcessTimeAct <= 999
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
    ...
    if (period == "Last Coil" || period.customp) {
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        if (
          ...
          if (EP?.pacing?.f_R2ProcessTimeAct?.toFixed(1) <= 1) {
            arr1.push(1);
          } else {
            arr1.push(0);
          }
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        let one = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (currentValue.f_R2ProcessTimeAct <= 1) {
              accumulator = accumulator + 1;
            }
          } else if (
            currentValue.f_F1GapTimeAct?.toFixed(2) >= index &&
        ...
        let five = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_R2ProcessTimeAct > 1 &&
              currentValue.f_R2ProcessTimeAct <= 5
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let ten = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_R2ProcessTimeAct >= 5 &&
              currentValue.f_R2ProcessTimeAct <= 10
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let nine = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_R2ProcessTimeAct >= 10 &&
              currentValue.f_R2ProcessTimeAct <= 999
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
    ...
    if (period == "Last Coil" || period.customp) {
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        if (
          ...
          if (EP?.pacing?.f_R1ProcessTimeAct?.toFixed(1) <= 1) {
            arr1.push(1);
          } else {
            arr1.push(0);
          }
      ...
      for (let index = start; index < end; index = index + 5) {
        ...
        let one = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (currentValue.f_R1ProcessTimeAct <= 1) {
              accumulator = accumulator + 1;
            }
          } else if (
            currentValue.f_F1GapTimeAct?.toFixed(2) >= index &&
        ...
        let five = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_R1ProcessTimeAct > 1 &&
              currentValue.f_R1ProcessTimeAct <= 5
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let ten = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_R1ProcessTimeAct >= 5 &&
              currentValue.f_R1ProcessTimeAct <= 10
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
        ...
        let nine = EP?.pacing?.reduce((accumulator, currentValue) => {
          if (
            ...
            if (
              currentValue.f_R1ProcessTimeAct >= 10 &&
              currentValue.f_R1ProcessTimeAct <= 999
            ) {
              accumulator = accumulator + 1;
            }
          } else if (
